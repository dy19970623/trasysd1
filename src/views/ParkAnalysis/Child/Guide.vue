<template>
  <div>
    <el-collapse v-model="activeNames" >
      <el-collapse-item title="一级诱导屏" name="1" style="color: crimson;">
        <div  id="a">
          <el-table :data="tableData1" border height="400" style="width: 100% ;background-color:rgba(0,0,0,0.2) ; "  @row-click="fly1">
            <el-table-column prop="屏号" label="屏号" width="50px"></el-table-column>
            <el-table-column prop="Parkingmessage" label="停车场情况（停车场名称：空余车位)" width="380px"></el-table-column>
          </el-table>
        </div>
      </el-collapse-item>
      <el-collapse-item title="二级诱导屏" name="2">
        <div id="b">
          <el-table :data="tableData2" border height="400" style="width: 100%" @row-click="fly2">
            <el-table-column prop="屏号" label="屏号" width="50px"></el-table-column>
            <el-table-column prop="Parkingmessage" label="停车场情况（停车场名称：空余车位)" width="380px"></el-table-column>
          </el-table>
        </div >
      ...
      <el-collapse-item title="三级诱导屏" name="3">
        <div id="c">
          <el-table :data="tableData3" border height="400" style="width: 100%"  @row-click="fly3">
            <el-table-column prop="屏号" label="屏号" width="50px"></el-table-column>
            <el-table-column prop="Parkingmessage" label="停车场情况（停车场名称：空余车位)" width="380nppx"></el-table-column>
          </el-table>
        </div>
      </el-collapse-item>
    </el-collapse>
