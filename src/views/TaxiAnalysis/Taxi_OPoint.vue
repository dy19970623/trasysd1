...
import {CarOdian1111} from '../../assets/js/TaxiAnalysis/TaxiHeatTimeData1'
...
var ODdian6={//20-23点
        ...
        data:[]
             ...
             for(var i=0;i<CarOdian1111.data.length;i++){
      var a=parseInt(CarOdian1111.data[i].time);

     switch(a) {
        case 0:case 1:case 2:case 3:
           var base={};
             base.lng= CarOdian1111.data[i].lng;
             base.lat= CarOdian1111.data[i].lat;
...
const myChart = this.$echarts.init(this.$refs.TaxiOPoint_container);
        var option1 = {
          textStyle:{
              color:'#FFFFFF'
            },
            ...
            options:[
                {
                    xAxis: [{
                        ...
                        data:["复兴路81-1号","西三环南路甲1号","建华南路5号","紫竹院路一号","东直门外小街45号","常青园路","宝钞胡同57号","新兴桥","太平桥大街","复兴门外大街甲1号"]
                    }],
                    title: {
                       textStyle:{
                    fontSize:20,
                    ...
                    series: [
                        {
                          type:'bar',
                            data: ["39","34","32","31","31","30","26","25","23","23"],
                            itemStyle: {
                            normal: {
                ...
                },
               {
                    ...
                    series: [
                        {
                          type:'bar',
                            data: ["75","66","49","48","41","40","40","35","34","33"]
                        },
                    ]
                },
     {
                    ...
                    series: [
                        {
                          type:'bar',
                            data: ["210","204","181","173","171","165","161","159","142","139"]
                        },
                    ]
                },
      {
                    ...
                    series: [
                        {
                          type:'bar',
                            data: ["166","153","148","146","132","128","107","103","93","92"]
                        },
                    ]
                },
                {
                    xAxis: [{
                        data: ["新兴桥","复兴门外大街甲1号","西滨河路1号","建华南路5号","紫竹院路一号","太平桥大街","东长安街18号","复兴路81-1号","丹棱街3号-a座","东直门外小街45号"]
                    }],
                    title: {
                       textStyle:{
                    fontSize:20,
                    ...
                    series: [
                        {
                          type:'bar',
                            data: ["253","212","199","185","182","180","168","159","142","138"]
                        },
                    ]
                },
                {
                    xAxis: [{
                        data:  ["新兴桥","复兴门外大街甲1号","建华南路5号","东长安街18号","丹棱街3号","西三环南路甲1号","太平桥大街","紫竹院路一号","宝钞胡同57号","西滨河路1号"]
                    }],
                    title: {
                       textStyle:{
                    fontSize:20,
                    ...
                    series: [
                        {
                          type:'bar',
                            data: ["216","167","158","157","155","130","125","124","117","117"]
                        },
                    ]
                },
            ]
...
#chart{
  ...
  background-image: url("../../../src/assets/image/border.png");
