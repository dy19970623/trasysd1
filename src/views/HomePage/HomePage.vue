<template>
    <div class="homepage">
      ...
      <div id="leftBox">
        <div  id="subwayChart"  class="grid-table" ></div>
        <div  id="busChart"  class="grid-table"></div>
        <div  id="bikeChart"  class="grid-table"></div>
      </div>
      <div id="rightBox">
        <div  id="parkChart"  class="grid-table"></div>
        <div  id="taxiChart"  class="grid-table"></div>
        <div  id="busAndTaxiChart"  class="grid-table"></div>
      </div>
<!--      <div id="chart">
        <el-row >
          <el-col :span="7">
...
*/
       ...
       let viewer = new Cesium.Viewer('cesiumContainer',{
         ...
         imageryProvider : new Cesium.MapboxStyleImageryProvider({
           ...
           username:'litaizeng',
           styleId: 'ckh4sgqak0i9319mywoay9rkv',
...
//         polyline.material = new Cesium.ColorMaterialProperty(Cesium.Color.MEDIUMSEAGREEN);
           ...
           [  		//各时段和数据
             {
               ...
               title: { text: '3:00-3:59出租车运行情况'},
               series:[{data:[4056,206,7547,50]}]
             },
             {
               title: { text: '4:00-4:59出租车运行情况'},
               series:[{data:[3580,177,8104,29]}]
             },
             {
               title: { text: '5:00-5:59出租车运行情况'},
               series:[{data:[3664,203,8007,32]}]
             },
             {
               title: { text: '6:00-6:59出租车运行情况'},
               series:[{data:[4181,459,7269,35]}]
             },
             {
               title: { text: '7:00-7:59出租车运行情况'},
               series:[{data:[4706,1653,5578,45]}]
             },
             {
               title: { text: '8:00-8:59出租车运行情况'},
               series:[{data:[4520,3444,4041,50]}]
             },
             {
               title: { text: '9:00-10:59出租车运行情况'},
               series:[{data:[4520,3444,4041,50]}]
             }
           ]
       }
     ...
     ParkChart()
     {
       ...
       let option = {
         ...
         color:['#B0E0E6','#91c7ae', '#61a0a8', '#6495ED']
       };
       myChart.setOption(option);
     },
     SubwayChart(){
         ...
         series: [
           {
             ...
             data: [
               {value: 288631, name: '海淀区'},
               {value: 287222, name: '朝阳区'},
               {value: 217150, name: '西城区'},
               {value: 169690, name: '东城区'},
               {value: 205162, name: '丰台区'},
               {value: 68832, name: '大兴区'},
               {value: 63162, name: '石景山区'},
               {value: 26891, name: '房山区'},
               {value: 86734, name: '昌平区'},
               {value: 26891, name: '门头沟区'},
               {value: 61900, name: '通州区'},
               {value: 8968, name: '平谷区'},
               {value: 11365, name: '怀柔区'},
               {value: 21722, name: '顺义区'},
               {value: 10675, name: '密云区'},
               {value:0,name:'延庆区'}
             ]
           },
           {
             ...
             data: [
               {value: 289472, name: '海淀区'},
               {value: 296288, name: '朝阳区'},
               {value: 210907, name: '西城区'},
               {value: 167828, name: '东城区'},
               {value: 201802, name: '丰台区'},
               {value: 62066, name: '大兴区'},
               {value: 66989, name: '石景山区'},
               {value: 26668, name: '房山区'},
               {value: 87618, name: '昌平区'},
               {value: 19325, name: '门头沟区'},
               {value: 60301, name: '通州区'},
               {value: 9499, name: '平谷区'},
               {value: 11738, name: '怀柔区'},
               {value: 23418, name: '顺义区'},
               {value: 10343, name: '密云区'},
               {value:9390,name:'延庆区'}
             ]
           }
         ]
